...
draft: false
---
Following the discussion in the [[Teaching/MAT246 Concepts in Abstract Math/2025 Summer/1/Introduction|Introduction]], I will assume that I intuitively know what a _set_ is, and that I can reasonably talk about the relation $\in$ in the language of sets. I write $x\in A$ if the set $x$ is _element of_ $A$, or in other words if $x$ _belongs to_ $A$.
...
![Powerset|300](https://upload.wikimedia.org/wikipedia/commons/thumb/e/ea/Hasse_diagram_of_powerset_of_3.svg/330px-Hasse_diagram_of_powerset_of_3.svg.png)
...
![intersection of two sets|300](https://upload.wikimedia.org/wikipedia/commons/thumb/6/6d/Venn_A_intersect_B.svg/500px-Venn_A_intersect_B.svg.png)
